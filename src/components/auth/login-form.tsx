...
export function LoginForm() {
  ...
  const isLoading = authLoading || isSubmitting || isSeeding;
  ...
  return (
    <>
      ...
      <div className="mt-6 text-center text-sm">
        <Button onClick={handleSeedDatabase} variant="link" className="text-muted-foreground" disabled={isSeeding}>
            {isSeeding ? (
                <>
                ...
                <>
                    ...
                    <span>Need sample data? Seed Database</span>
                </>
            )}
        </Button>
      </div>
