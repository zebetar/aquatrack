...
export function EditPaymentRecordForm({ existingPayment, onSuccess }: EditPaymentFormProps) {
  ...
  const form = useForm<EditPaymentFormValues>({
    ...
    defaultValues: {
      paymentDate: new Date(existingPayment.paymentDate),
  ...
  async function onSubmit(values: EditPaymentFormValues) {
    ...
    const updatedPayment: Payment = {
      ...existingPayment, // Preserve ID, customerId, customerName, recordedBy, createdAt
